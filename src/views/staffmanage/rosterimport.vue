<template>
  <div class="container">
    ...
    <span @click="getDownload" class="fCOlor">员工花名册模板</span>
  </div>
</template>

<script>
// import { bulkImport, downloadTemplate } from '@src/api/roster/index.js';
...
export default {
    ...
    methods: {
        ...
        getDownload() {
            ...
            let url = '/importTemplate/downloadEmployeeTemplate?' + parms;
            downFile(url);
        }
    }
};
